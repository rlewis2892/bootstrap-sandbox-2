	...
	<body>
		...
		<section id="photography">
			<div class="container section-breaker col-md-offset-1 col-md-8">
				<a name="photography"></a><h2 class="text-left">Photography</h2>
				<p class="text-left">I spent around four years in the Seattle, WA area. Here are some of my favorite photos I took during the time. Sony mirrorless cameras! Woo!</p>
				<div class="row">
		...
		<section id="gaming">
			<div class="container section-breaker col-md-offset-6 col-md-5">
				<a name="gaming"></a><h2 class="text-right">Gaming</h2>
				<p class="text-right">This is Heroes of the Storm, the Blizzard MOBA. My first pentakill as Gazlowe!</p>
				<iframe class="pull-right" width="560" height="315" src="https://www.youtube.com/embed/PoFQFHzPREQ" frameborder="0" allowfullscreen></iframe>
			</div>
		</section>

		<section id="videography">
			<div class="container section-breaker col-md-offset-1 col-md-8">
				<h2 class="text-left">Videography</h2>
				<p class="text-left">This is a video I created from a photo shoot with Sony Vegas.</p>
				<div class="pull-left">
					<iframe width="560" height="315" src="https://player.vimeo.com/video/103035213?portrait=0" frameborder="0" allowfullscreen></iframe>
				</div>
			</div>
		</section>
		...
		<section id="music">
			<div class="container section-breaker col-md-8 col-md-offset-3">
				<a name="music"></a><h2 class="text-right">Music</h2>
